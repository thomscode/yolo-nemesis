module.exports =
	...
	uuid: "9ACE4D32-3119-4647-9ADB-B3F5B5C7AEAB"
	gutterSettings:
		background: "#073642"
		divider: "#586e75"
		foreground: "#839496"
		selectionBackground: "#586e75"
		selectionForeground: "#679c00"
	settings: [
		{
			settings:
				activeGuide: "#7fb11b"
				background: "#fafafa"
				bracketContentsForeground: "#49483ea5"
				bracketContentsOptions: "underline"
				bracketsForeground: "#49483ea5"
				...
				foreground: "#49483e"
				invisibles: "#3b3a32"
				lineHighlight: "#e6e3c4"
				selection: "#ccc9ad"
				selectionBorder: "#93917d"
				stackGuide: "#635f2d"
